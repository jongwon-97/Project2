...
public class FileServiceImpl implements FileService {
    ...
    @Override
    public ImageDTO findImageDTObyFileId(int fileId) {
        return fileMapper.findImageDTObyFileId(fileId);
    }

    @Override
    public void deleteContentById(int fileId) {
        fileMapper.deleteContentById(fileId);
    }

    @Override
    public int findContentOrder(int fileId) {
        return fileMapper.findContentOrder(fileId);
    }

    @Override
    public int getMaxContentOrderByBoardId(int boardId) {
        return fileMapper.getMaxContentOrderByBoardId(boardId);
    }
